...
Sau khi có HĐ, robot `memo-drafter` sinh memo 5 sections (IRAC):
...
- Nếu cần redline lại HĐ → `contract-redliner`
- Nếu so sánh với HĐ chuẩn của firm → `benchmark-comparator`
