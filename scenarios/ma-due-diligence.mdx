...
<CardGroup cols={2}>
  <Card title="Bước 1: Audit thuế" icon="receipt">
    ...
    Robot dùng: `legal-compliance-tax`
  </Card>
  ...
  <Card title="Bước 4: Audit License" icon="clipboard-check">
    ...
    Robot dùng: `legal-compliance-audit`
  </Card>
</CardGroup>

**Bước 5: Dashboard tổng hợp**

Robot `legal-compliance-dashboard` đọc 4 báo cáo audit → tính điểm sức khỏe 0-100 + xếp hạng top 5 rủi ro lớn nhất.
...
3. Negotiate SPA + escrow → dùng `legal-share-transfer-contract-drafter`
4. Sau ký, monitor compliance → dùng `legal-matter-tracker`
