...
<AccordionGroup>
  <Accordion title="Bước 1 — FDI check (nếu có nước ngoài)">
    Robot `compliance-fdi` kiểm 5 trục:
  ...
  <Accordion title="Bước 2 — Governance docs (JSC/LLC)">
    Robot `corporate-governance-drafter` (umbrella 3 nhánh):
...
- Setup compliance monitoring → `compliance-audit`
