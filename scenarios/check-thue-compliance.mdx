...
<AccordionGroup>
  <Accordion title="Bước 1 — Audit 4 trục thuế">
    Robot `legal-compliance-tax` kiểm:
  ...
  <Accordion title="Bước 2 — Letter giải trình (nếu Sở thuế yêu cầu)">
    Robot `legal-compliance-letter-drafter`:
...
<CardGroup cols={3}>
  ...
  <Card title="Letter compliance" icon="envelope" href="/skills/compliance/compliance-letter-drafter">
    legal-compliance-letter-drafter
  </Card>
...
- Annual review tax compliance → tích hợp vào `legal-compliance-dashboard`
