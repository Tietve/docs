...
<AccordionGroup>
  <Accordion title="Robot Knowledge Base (cho Q&A common)">
    `legal-knowledge-base` có **34 thẻ kiến thức** chia 15 chủ đề:
  ...
  <Accordion title="Robot VN Law Search (cho câu hỏi mới / chi tiết)">
    `legal-vn-law-search` — Tavily MCP-first:
...
- Nếu cần memo dài → [Soạn HĐ cho client](/scenarios/soan-hop-dong) + `legal-memo-drafter`
